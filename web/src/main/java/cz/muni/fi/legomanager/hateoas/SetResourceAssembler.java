 ...
 */
@Component
public class SetResourceAssembler extends ResourceAssemblerSupport<SetOfKitsDTO, SetResource> {


    private EntityLinks entityLinks;

    private final static Logger log = LoggerFactory.getLogger(SetResourceAssembler.class);

    public SetResourceAssembler(@SuppressWarnings("SpringJavaAutowiringInspection")
